...
public class SyncMethods extends Main {
	...
	*/ 
    ...
    /**
     * Generic wait for web element = clickable
     * */
    ...
    /**
     * Generic wait for web element = visible
     * */
    ...
    public static void manualProcessSlowdownDefaultVal(){
    	sleep(5000);
	}
    
    
	public static void manualProcessSlowndownSeven(){
    	sleep(7000);
	}
